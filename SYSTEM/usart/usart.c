...
void USART3_Init(u32 bound)
{
   //GPIO端口设置
	...
	//串口3对应引脚复用映射
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource10,GPIO_AF_USART3); //GPIO B10 复用为USART3 TX
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource11,GPIO_AF_USART3); //GPIO B11 复用为USART3 RX

	//USART3 端口配置 //GPIO B10 (TX)与 GPIO B11 (RX)
